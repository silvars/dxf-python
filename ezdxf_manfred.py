...
# using text styles
dwg.styles.new('custom', dxfattribs={'font': '/home/rodrigo/Downloads/MITSUBISHI 2015.ttf', 'width': 0.8})  # Arial, default width factor of 0.8
msp.add_text("L", dxfattribs={'style': 'custom', 'height': 0.35}).set_pos((2, 6), align='LEFT')
